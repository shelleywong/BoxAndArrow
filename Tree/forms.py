...
FUNCTION_NAMES = [('insert', 'insert'), ('find', 'find'), ('size', 'size'),
    ('print_inorder', 'print_inorder'), ('print_preorder', 'print_preorder'), 
    ('print_postorder', 'print_postorder'), ('balanced', 'balanced')]

class TreeCmds(FlaskForm):
    name1 = SelectField(
        'Function 1 Command', 
