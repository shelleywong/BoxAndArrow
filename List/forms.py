...
FUNCTION_NAMES = [('insert', 'insert'), ('lookup', 'lookup'), 
    ('length', 'length'), ('print', 'print'), ('remove', 'remove'),
    ('insert_at_end', 'insert_at_end'), ('remove_head', 'remove_head')]

class ListCmds(FlaskForm):
    name1 = SelectField(
        'Function 1 Command', 
